                ...
                <div className="max-w-7xl mx-auto w-full p-4 md:p-8 lg:p-10 flex flex-col gap-8">
                    ...
                    <header className="flex flex-wrap justify-between items-end gap-4">
                        <div className="flex flex-col gap-1">
                            <h1 className="text-3xl md:text-4xl font-black text-text-main dark:text-white tracking-tight">Calendario de Actividades</h1>
                            <p className="text-text-muted dark:text-gray-400 text-base font-normal">Planifica y revisa tus eventos y metas.</p>
                        </div>
                    </header>
                    <Calendar />
                </div>
